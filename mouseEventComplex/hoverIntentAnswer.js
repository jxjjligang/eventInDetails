...
class HoverIntent {
    ...
    onMouseMove(event) {
        console.log(`${(new Date()).getTime()} , x:${event.pageX}, y:${event.pageY}, order:${this.mouseMove}`);
    ...
    trackSpeed() {
        ...
        if (!this.lastTime || this.lastTime == this.prevTime) {
            ...
            let timeDif = this.lastTime - this.prevTime;
            speed = length / timeDif;
            console.log(`length:${length}, timeDif:${timeDif}, speed:${speed}`);
        }
